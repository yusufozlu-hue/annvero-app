export const ANNVERO_NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      { label: "Sistem Hata ve İşlem Logları", href: "/sistem-loglari" },
      { label: "Parametreler", href: "/admin/parametre-yonetimi" },
      { label: "Mevzuat Hap Notları", href: "/admin/mevzuat-hap-notlari" },
      { label: "Firma Yönetimi", href: "/muhasebe/firma-yonetimi" },
      { label: "Entegrasyonlar", href: "/otomasyon?view=integrations" },
      { label: "Kullanıcılar & Roller", href: "/admin/kullanicilar-roller" },
      { label: "Roller & Yetkiler", href: "/admin/kullanicilar-roller" },
      { label: "Sistem Ayarları", href: "/admin/parametre-yonetimi" },
      { label: "Backup / Migration", href: "/muhasebe/firma-yonetimi" },
