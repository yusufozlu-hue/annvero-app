...
/**
 * TEB 14-kolon hesap hareketleri ihracatı (anonim yapısal fixture).
 * Gerçek müşteri verisi yok — detection + kolon eşleme testleri için.
 */
export const FIXTURE_TEB_FOURTEEN_COLUMN_ANON = {
  sheetName: "Hesap Hareketleri",
  fileName: "hesap-hareketleri-anon.xlsx",
  rows: [
    ["Anonim Firma Ekstresi", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ["", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ["", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ["", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ["", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ...
    [
      ...
      "Valör",
      "Saat",
      "İşlemi Giren Kullanıcı",
      "Açıklama",
      "Banka",
      "Unvan",
      "Alıcı Hesap / IBAN / Kart No",
      "Özel İşlem Açıklaması",
      "EFT Sorgu No",
      "Tutar",
      "Bakiye",
      "Dekont",
