...
const ROUTES = [
  ...
  ["Firma Yönetimi", "/muhasebe/firma-yonetimi", "app/muhasebe/firma-yonetimi/page.jsx"],
  ["Hesap Planı", "/muhasebe/hesap-plani", "app/muhasebe/hesap-plani/page.jsx"],
  ["Kural Motoru", "/muhasebe/kural-motoru", "app/muhasebe/kural-motoru/page.jsx"],
  ["Banka Parser", "/muhasebe/banka-ekstresi", "app/muhasebe/banka-ekstresi/page.jsx"],
  ["Fiş Üretim / Dönüştürme", "/muhasebe/fis-donusturme", "app/muhasebe/fis-donusturme/page.jsx"],
  ["Luca Dönüştürücü", "/muhasebe/luca-donusturucu", "app/muhasebe/luca-donusturucu/page.jsx"],
  ["Fiş Kontrol Merkezi", "/muhasebe/fis-kontrol", "app/muhasebe/fis-kontrol/page.jsx"],
  ["Banka & Kart Operasyon", "/muhasebe/banka-kart-operasyon", "app/muhasebe/banka-kart-operasyon/page.jsx"],
  ["Banka Mutabakat", "/muhasebe/banka-mutabakat", "app/muhasebe/banka-mutabakat/page.jsx"],
  ["Mali Yükümlülük", "/muhasebe/mali-yukumluluk", "app/muhasebe/mali-yukumluluk/page.jsx"],
  ["Beyanname / Tahakkuk", "/muhasebe/beyanname-tahakkuk", "app/muhasebe/beyanname-tahakkuk/page.jsx"],
  ["Poliçe Giderleştirme", "/muhasebe/police-giderlestirme", "app/muhasebe/police-giderlestirme/page.jsx"],
  ["E-Defter Kontrol", "/muhasebe/e-defter-kontrol", "app/muhasebe/e-defter-kontrol/page.jsx"],
  ["Luca Aktarım Kontrol", "/muhasebe/luca-aktarim-kontrol", "app/muhasebe/luca-aktarim-kontrol/page.jsx"],
  ["Adat Hesaplama", "/muhasebe/adat-hesaplama", "app/muhasebe/adat-hesaplama/page.jsx"],
  ["Kur Değerleme", "/muhasebe/kur-degerleme", "app/muhasebe/kur-degerleme/page.jsx"],
  ["Finansman Gider", "/muhasebe/finansman-gider-kisitlamasi", "app/muhasebe/finansman-gider-kisitlamasi/page.jsx"],
  ["Personel / İK", "/ik-personel", "app/ik-personel/page.jsx"],
  ["Ticaret Sicil", "/ticaret-sicil", "app/ticaret-sicil/page.jsx"],
  ["Resmi Bildirimler", "/dashboard/ofis-takip/resmi-bildirimler", "app/dashboard/ofis-takip/resmi-bildirimler/page.jsx"],
  ["Hesaplama Araçları", "/platform/hesaplama-araclari", "app/platform/hesaplama-araclari/page.jsx"],
  ["Maaş Hesaplama", "/platform/hesaplama-araclari/maas-hesaplama", "app/platform/hesaplama-araclari/maas-hesaplama/page.jsx"],
  ["Öğrenen Hafıza", "/muhasebe/ogrenen-hafiza", "app/muhasebe/ogrenen-hafiza/page.jsx"],
  ["İşlem Hafızası", "/muhasebe/islem-hafizasi", "app/muhasebe/islem-hafizasi/page.jsx"],
  ["Risk Denetim", "/muhasebe/risk-denetim-merkezi", "app/muhasebe/risk-denetim-merkezi/page.jsx"],
  ["AI Kontrol", "/muhasebe/ai-kontrol", "app/muhasebe/ai-kontrol/page.jsx"],
  ["AI Ofis Asistanı", "/ai-ofis-asistani", "app/ai-ofis-asistani/page.jsx"],
  ["Otomasyon", "/otomasyon", "app/otomasyon/page.jsx"],
  ["ElektraWeb", "/muhasebe/elektraweb", "app/muhasebe/elektraweb/page.tsx"],
  ["KDV Matrah", "/muhasebe/kdv-matrah-kontrol", "app/muhasebe/kdv-matrah-kontrol/page.jsx"],
  ["Toplu Kıdem İhbar", "/muhasebe/toplu-kidem-ihbar", "app/muhasebe/toplu-kidem-ihbar/page.jsx"],
];
